...
- [ ] `step0_start()` - session_start event
- [ ] `step1_analyze()` - tool_start/end/error
- [ ] `step1_fix_auto()` - tool_start/end/error
- [ ] `step1_fix_manual()` - tool_start/end/error
- [ ] `step2_validate()` - tool_start/end/error + validation_complete
- [ ] `step4_export()` - tool_start/end/error + export_complete
- [ ] All errors include stacktrace + context

### TypeScript (qf-scaffolding)

- [ ] `load_stage()` - tool_start/end/error
- [ ] `load_stage()` - stage_start when stage begins
- [ ] `load_stage()` - stage_complete when teacher approves
- [ ] All errors include stack trace
